...
The following example shows a classification summary for each genome or taxonomic unit.  The assignment output has 7 columns.
    ...
    Wigglesworthia glossinidia endosymbiont of Glossina brevipalpis	36870	no rank	   703004		5981	   5964	            0.0152317
    ...
    The third column is the taxonomic rank (e.g., no rank).
